...
############################################################################################
#########   Step III - Build Your Own CNN Model    ######################################
############################################################################################
import hw2
...
def cnn_model_correctness(idx):
    ...
    if not(z1.shape == y2.shape): print("FAILURE")
...
if __name__ == '__main__':
    ...
    print('Step I - Convolutional Layer')

    print('Step I - Forward')
    ...
    # Step II
    print('Step II - CNN as a Simple Scanning MLP')
    ...
    # Step II
    print('Step II - CNN as a Distributed Scanning MLP')
    ...
    print('Step III - CNN Complete Model')
