...
class RNN_Phoneme_Classifier(object):
    ...
    def backward(self, delta):
        ...
        * Notes:
        * Pease refer to hw3_readme.pdf for the explanation of the input and output parameters of the rnn cell backward function 
        * The visualization of backward process is shown in hw3_reademe.pdf
